...
def recommendations_view(request):
    dotenv_path = 'C:\\Users\\NITRO\\Taller3-PI1\\openAI.env'
    ...
    with open('C:\\Users\\NITRO\\Taller3-PI1\\movie_descriptions_embeddings.json', 'r') as file:
